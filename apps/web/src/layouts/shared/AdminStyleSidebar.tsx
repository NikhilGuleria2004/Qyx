...
import { Users, Hash, Shield, Settings, FileText, Monitor, KeyRound, Bell, Plus } from 'lucide-react';
    ...
    <div className="hidden lg:flex lg:w-64">
      <div className="flex h-full w-full flex-col border-r border-hairline bg-surface">
        <div className="flex h-9 items-center border-b border-hairline px-3">
          <span className="text-xs font-medium text-text-secondary uppercase tracking-wider">Admin</span>
        </div>
